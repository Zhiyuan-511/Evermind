...
DEFAULT_SETTINGS = {
    ...
    "node_model_preferences": {
        "router": ["gpt-4o-mini", "kimi-coding"],
        "planner": ["gpt-4o-mini", "kimi-coding"],
        "analyst": ["gpt-4o-mini", "kimi-coding"],
        "uidesign": ["gpt-4o-mini", "kimi-coding"],
        "scribe": ["gpt-4o-mini", "kimi-coding"],
        "builder": ["gpt-4o-mini", "kimi-coding"],
        "polisher": ["gpt-4o-mini", "kimi-coding"],
        "reviewer": ["gpt-4o-mini", "kimi-coding"],
        "tester": ["gpt-4o-mini", "kimi-coding"],
        "debugger": ["gpt-4o-mini", "kimi-coding"],
        "deployer": ["gpt-4o-mini", "kimi-coding"],
        "imagegen": ["gpt-4o-mini", "kimi-coding"],
        "spritesheet": ["gpt-4o-mini", "kimi-coding"],
        "assetimport": ["gpt-4o-mini", "kimi-coding"],
        "merger": ["gpt-4o-mini", "kimi-coding"],
    },
    "max_retries": 3,
