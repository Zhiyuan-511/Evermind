...
def main():
    ...
    print(f"🔍 Launching {mode_label} Chromium...")
    try:
        with sync_playwright() as p:
            ...
            title = page.title()
            print(f"✅ Local page rendered: '{title}'")
            ...
            try:
                ...
                print("✅ External network check passed (example.com)")
            except Exception as net_err:
                print(f"⚠️ External network check skipped/failed: {net_err}")
        ...
        if "Executable doesn't exist" in msg:
            print("❌ Chromium not installed yet.")
