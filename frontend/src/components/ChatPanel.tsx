...
export default function ChatPanel({
    ...
    // v6.2: listen for template pre-fill events dispatched
    ...
    return (
        <div className="glass-strong flex flex-col h-full border-l border-white/5" style={{ width: '100%', minWidth: 0, flexShrink: 0, overflow: 'hidden' }}>
            ...
            <div className="p-3 border-t border-white/5">
                ...
                {/* Difficulty selector — v7.1i: 5 modes incl. Ultra.
                ...
                <div style={{
                    ...
                    {(() => {
                        ...
                        // v7.2: Custom mode is no longer a
